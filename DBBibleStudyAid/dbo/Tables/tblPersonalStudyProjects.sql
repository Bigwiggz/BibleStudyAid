...
(
    ...
    [PersonalStudyFindingsId] INT NOT NULL, 
    CONSTRAINT [FK_tblPersonalStudyProjects_tblPersonalStudyProjects] FOREIGN KEY ([PersonalStudyFindingsId]) REFERENCES [tblPersonalStudyProjects]([Id])
)
